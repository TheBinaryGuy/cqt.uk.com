...
const FirstAidForMentalHealthYoungPeople = () => (
...
FirstAidForMentalHealthYoungPeople.pageTitle =
    'First Aid for Mental Health Young People';

export default FirstAidForMentalHealthYoungPeople;
