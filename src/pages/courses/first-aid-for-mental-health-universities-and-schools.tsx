...
const FirstAidForMentalHealthUniversitiesAndSchools = () => (
...
FirstAidForMentalHealthUniversitiesAndSchools.pageTitle =
    'First Aid for Mental Health Universities and Schools';

export default FirstAidForMentalHealthUniversitiesAndSchools;
